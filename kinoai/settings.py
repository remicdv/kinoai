"""
Django settings for kinoai project.
...
WSGI_APPLICATION = 'kinoai.wsgi.application'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 505242880
DATA_UPLOAD_MAX_NUMBER_FIELDS = 15242880
